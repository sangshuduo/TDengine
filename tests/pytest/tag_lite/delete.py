...
class TDTestCase:
    ...
    def run(self):
        ...
        tdLog.info('tdSql.checkData(2, 1, BIGINT)')
        tdSql.checkData(2, 1, BIGINT)
        # TSIM: return -1
        #TSIM: endi
        # TSIM: if $data31 != FLOAT then
        tdLog.info('tdSql.checkData(3, 1, FLOAT)')
        ...
        tdLog.info('tdSql.checkData(2, 1, SMALLINT)')
        tdSql.checkData(2, 1, SMALLINT)
        # TSIM: return -1
        #TSIM: endi
        # TSIM: if $data31 != TINYINT then
        tdLog.info('tdSql.checkData(3, 1, TINYINT)')
        tdSql.checkData(3, 1, TINYINT)
        # TSIM: return -1
        #TSIM: endi
        # TSIM: if $data41 != BINARY then
        tdLog.info('tdSql.checkData(4, 1, BINARY)')
        tdSql.checkData(4, 1, BINARY)
        # TSIM: return -1
        #TSIM: endi

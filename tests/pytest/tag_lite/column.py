...
class TDTestCase:
    ...
    def run(self):
        ...
        #TSIM: $i = 0
        i = 0
        #TSIM: sql create table $mt (ts timestamp, tbcol int, tbcol2 binary(10)) TAGS(tgcol int, tgcol2 binary(10))
        tdLog.info('create table %s (ts timestamp, tbcol int, tbcol2 binary(10)) TAGS(tgcol int, tgcol2 binary(10))' % (mt))
        tdSql.execute('create table %s (ts timestamp, tbcol int, tbcol2 binary(10)) TAGS(tgcol int, tgcol2 binary(10))' % (mt))
        #TSIM: 
        #TSIM: print =============== step2
        tdLog.info('=============== step2')
        #TSIM: 

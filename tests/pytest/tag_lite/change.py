...
class TDTestCase:
    ...
    def run(self):
        ...
        #TSIM: $mt = $mtPrefix . $i
        #TSIM: $tb = $tbPrefix . $i
        #TSIM: sql create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bool, tgcol2 int)
        tdLog.info("create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bool, tgcol2 int)")
        tdSql.execute('create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bool, tgcol2 int)')
        ...
        #TSIM: $mt = $mtPrefix . $i
        #TSIM: $tb = $tbPrefix . $i
        #TSIM: sql create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 smallint, tgcol2 tinyint)
        tdLog.info("create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 smallint, tgcol2 tinyint)")
        tdSql.execute('create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 smallint, tgcol2 tinyint)')
        #TSIM: sql create table $tb using $mt tags( 1, 2 )
        ...
        #TSIM: $mt = $mtPrefix . $i
        #TSIM: $tb = $tbPrefix . $i
        #TSIM: sql create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bigint, tgcol2 float)
        tdLog.info("create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bigint, tgcol2 float)")
        tdSql.execute('create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 bigint, tgcol2 float)')
        #TSIM: sql create table $tb using $mt tags( 1, 2 )
        ...
        #TSIM: $mt = $mtPrefix . $i
        #TSIM: $tb = $tbPrefix . $i
        #TSIM: sql create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 double, tgcol2 binary(10))
        tdLog.info("create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 double, tgcol2 binary(10))")
        tdSql.execute('create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 double, tgcol2 binary(10))')
        #TSIM: sql create table $tb using $mt tags( 1, '2' )
        ...
        #TSIM: $mt = $mtPrefix . $i
        #TSIM: $tb = $tbPrefix . $i
        #TSIM: sql create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 binary(10), tgcol2 int, tgcol3 smallint, tgcol4 binary(11), tgcol5 double, tgcol6 binary(20))
        ...
        tdSql.execute('create table $mt (ts timestamp, tbcol int) TAGS(tgcol1 binary(10), tgcol2 int, tgcol3 smallint, tgcol4 binary(11), tgcol5 double, tgcol6 binary(20))')

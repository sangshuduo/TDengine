    ...
    def addColumnAndCount(self):
        for colIdx in range(len(self.types)):
            ...
            for i in range(2, colIdx + 2):
                tdLog.info("check1: i=%d colIdx=%d" % (i, colIdx))
            ...
            for i in range(2, colIdx + 2):
                tdLog.info("check2: i=%d colIdx=%d" % (i, colIdx))
...
# comment off by Shuduo        print res.join
    ...
    def run(self):
        ...
        tdSql.execute("create database %s rows 200 tables 4" % (db))
